        ...
        if (hasDirectoryExists) {
            ...
            return {
                ...
                directoryExists: path => {
                    return _has(directories, path);
                },
                fileExists: path => {
                    assert.isTrue(_has(directories, getDirectoryPath(path)), `'fileExists' '${path}' request in non-existing directory`);
